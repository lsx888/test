...
public class BaseUtils {
	 ...
	 * 
	 * @param mny
	 *            待转化的金额 851256211.56 捌亿伍仟壹佰贰拾伍万陆仟贰佰壹拾壹元伍角陆分
	 *            23433211234343323851256211.56
	 * @return 返回金额的汉字大写
	 */
	public static String toMoneyUpper(String mny) {
		double amount = Double.parseDouble(mny);
		...
		for (int i = 0; i < numParts; i++) {
			partChinese = partTranslate(parts[i]);
			if (i % 2 == 0) {
